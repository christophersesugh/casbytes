      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-8 w-full">
          <div className="mb-8 grid grid-cols-4">
            ...
            <div className="hidden md:block border bg-slate-200/70">
              <h1 className="text-lg text-slate-100 bg-blue-600 rounded-t-md mb-4 p-2">
                Progress
              </h1>
              <ul className="flex flex-wrap gap-4 p-4">
                <Button
                  variant="secondary"
                  className="p-1 m-0  bg-slate-300 inline-block"
                >
                  <CheckCircle />
                </Button>
                {Array.from({ length: 5 }).map((_, i) => (
                  <li key={i} className="flex items-center gap-2">
                    <Button
                      variant="secondary"
                      className="p-1 m-0 inline-block bg-slate-300 text-black"
                    >
                      <Lock />
                    </Button>
                  </li>
